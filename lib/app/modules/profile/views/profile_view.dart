                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            height: (controller.academyDataModel.data != null ? controller.academyDataModel.data!.data?.length ?? 1 : 1) * 100.h ,
                            child: controller.academyDataModel.data != null ? ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return GestureDetector(
                                    onTap: () {
                                      if (controller.academyDataModel.data !=
                                          null) {
                                        Get.toNamed(AppPages.ACADEMY_DETAILS,
                                            arguments: {
                                              "data": controller
                                                  .academyDataModel
                                                  .data
                                    ...
                                    child: ProductCard(
                                        data: DetailsModel(
                                            ...
                                            name: controller.academyDataModel
