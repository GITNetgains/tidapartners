...
import 'package:tidapartners/app/modules/past_bookings/controllers/past_bookings_controller.dart';
...
class FilterWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<PastBookingsController>(
