...
class SubscriptionOrdersModel {
    ...
    SubscriptionOrdersModel({this.totalOrders, this.maxPages, this.currentPage, this.data});

    SubscriptionOrdersModel.fromJson(Map<String, dynamic> json) {
...
class Data {
    ...
    Data.fromJson(Map<String, dynamic> json) {
        ...
        if(json["subscriptions_ids"] is Map) {
            subscriptionsIds = json["subscriptions_ids"] == null ? null : json["subscriptions_ids"];
        }
    ...
    Map<String, dynamic> toJson() {
        ...
        if(subscriptionsIds != null) {
            _data["subscriptions_ids"] = subscriptionsIds?.toJson();
        }
        if(customer != null) {
...
class Items {
    ...
    Items({this.type, this.academyName, this.academyAddress, this.packageName, this.packageAmount, this.personName, this.image, this.partnerName, this.partnerPhone});
...
class Subscriptions {
    ...
    Subscriptions({this.id, this.trialEnd, this.total, this.nextPayment, this.start, this.end, this.subscriptionLength});
