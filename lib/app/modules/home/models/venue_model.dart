...
class VenueOrdersModel {
    ...
    VenueOrdersModel({this.totalOrders, this.maxPages, this.currentPage, this.data});
...
class Data {
    ...
    Data({this.id, this.status, this.currency, this.createdDate, this.transactionId, this.customer, this.items});
...
class Items {
    ...
    Items({this.venue, this.slots});

    Items.fromJson(Map<String, dynamic> json) {
        if(json["0"] is Map) {
            venue = json["0"] == null ? null : Venue.fromJson(json["0"]);
        }
...
class Slots {
    ...
    Slots({this.dayTime, this.bookingId, this.slotAmount, this.slotStartDate, this.slotEndDate, this.slotStartTime, this.slotEndTime, this.slotName});
...
class Venue {
    ...
    Venue({this.name, this.address, this.personName, this.user});
...
class User {
    ...
    User({this.data, this.id, this.caps, this.capKey, this.roles, this.allcaps, this.filter});
    ...
    User.fromJson(Map<String, dynamic> json) {
        ...
        if(json["allcaps"] is Map) {
            allcaps = json["allcaps"] == null ? null : Allcaps.fromJson(json["allcaps"]);
        }
        filter = json["filter"];
    }
...
class Allcaps {
    ...
    Allcaps({this.read, this.customer});
...
class Data1 {
    ...
    Data1({this.id, this.userLogin, this.userPass, this.userNicename, this.userEmail, this.userUrl, this.userRegistered, this.userActivationKey, this.userStatus, this.displayName});
